...
public class AIStateMachine <E, S extends State<E>> implements StateMachine<E, S> {
    ...
    public AIStateMachine (E owner, S initialState) {
    ...
    public AIStateMachine (E owner, S initialState, S globalState) {
        this.owner = owner;
    ...
    public void setGrid(GridActor grid) {
        this.grid = grid;
    }
